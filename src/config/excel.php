    ...
    */
    ...
    'export'     => array(
        ...
        */
        ...
        | 默认值是基于一个估计，它计算的基础关于单元格值中的字符数（应用任何计算）
            和格式掩码，并允许自动换行和旋转）和一个“任意”的基础上的字体（宋体，宋体宋体或调整，违约Calibri如果任何其他字体使用）和比例
            字体大小调整。
        |
        | --> PHPExcel_Shared_Font::AUTOSIZE_METHOD_EXACT
        第二种方法更准确，基于实际样式格式化为（粗体、斜体、井等），并产生一个imagettf GD2计算
        包围盒和使用它的尺寸的大小来确定；但这方法是很慢的，其精度仍然依赖具有相应安装字体。
        |
        */
